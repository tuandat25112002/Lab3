...
if(!isset($category_id)){
  ...
  if(isset($_GET['submitsearch'])){
                ...
                // echo 'alert("Nhập tên giày cần tìm kiếm")'; 
                // echo '</script>';

      

                if($_GET['searchinput']!=""){
                $productname=$_GET['searchinput']; 
...
<html lang="en">
  ...
  <body style=" background-color:rgb(245, 245,245);">
    ...
    <div class="container-fluid">
        <p><a class="text-dark " style="text-decoration: none;" href="">ADMIN</a> <i class="fas fa-angle-double-right"></i> <a href="index.php" style="text-decoration: none;" class="text-primary">PRODUCT MANGER</a></p>
      ...
      <!-- <div class="containter-fluid justify-content-center"> -->
       <div class="col-sm-12 justify-content-center row ">
            <form class="searchbar" action="" method="get">
                    <input name="searchinput" class="search_input" id="search-input" value="" type="text" placeholder="Search...">
                    
                    
                    <button type="submit" name="submitsearch" class="btn btn-link search_icon"> <i class="fas fa-search"></i></button>
                </form>
                </div>
            <!-- </div> -->
             <hr>   
 ...
 <form action="add_product.php"  method="get">
      ...
      <button type="submit" name="gettotalpages" class="btn btn-link" style="margin:10px 0px;padding:10px 0px;text-decoration: none;"><i class="fas fa-plus"></i> Add a Product</button></form>
        ...
        <div class="col-sm-10">
           <h6 style="margin:30px 0px"><b>Search Results</b>: <?php echo $_GET["searchinput"]?></h6>
            <?php
           ...
           <div style="overflow-x:auto;">
            ...
            $sqlproduct = "SELECT * from products where nameproduct like '%$productname%'";
